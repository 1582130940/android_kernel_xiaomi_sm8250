...
#endif
#if defined(CONFIG_ARCH_KONA) || defined(CONFIG_TARGET_PRODUCT_ELISH)
...
#ifdef AUDIO_SM8250_FLAG
	{/* hw:x,30 */
#if defined(CONFIG_TARGET_PRODUCT_APOLLO) || defined(CONFIG_TARGET_PRODUCT_CAS) || defined(CONFIG_TARGET_PRODUCT_ALIOTH)|| defined(CONFIG_ARCH_KONA) || defined(CONFIG_TARGET_PRODUCT_ELISH)
